...
\centering
\begin{tabular}{>{\raggedright\arraybackslash}p{4cm}l>{\raggedright\arraybackslash}p{7cm}rr}
\toprule
...
también surgen otras ocupaciones relevantes como ``Vendedores y
asistentes de venta de tiendas, almacenes y puestos de mercado''
``Vendedores y asistentes de venta de tiendas, almacenes y puestos de
mercado'' que es la ocupación con más vacantes sin llenar en los
sectores de ``Actividades financieras y de seguros'' y ``Comercio''.
...
Al analizar las ocupaciones de difícil cobertura según el sector de
actividad económica, como se muestra en la
Tabla~\ref{tbl-vacantes_constru}, se vuelve a confirmar la dificultad
para llenar vacantes de ``Obreros de explotaciones agrícolas'', pero
también surgen otras ocupaciones relevantes como ``Vendedores y
asistentes de venta de tiendas, almacenes y puestos de mercado'' que es
la ocupación con más vacantes sin llenar en los sectores de
``Actividades financieras y de seguros'' y ``Comercio''.
...
\centering
\begin{tabular}{l>{\raggedleft\arraybackslash}p{7cm}rr}
\toprule
Cargo Construcción & Vacantes & \% del total & CV\\
\midrule
Obreros y jornales & 1271 & 39,49 & 46\\
Carpinteros & 495 & 15,37 & 52\\
Soldadores & 406 & 12,61 & 83\\
Otros maestros de primera y segunda & 184 & 5,71 & 90\\
Ingenieros, prevencionistas, arqueólogos, otros profesionales & 137 & 4,26 & 54\\
\addlinespace
Pintores & 131 & 4,08 & 59\\
Enfierradores & 119 & 3,68 & 58\\
Albañiles & 101 & 3,14 & 44\\
Capataces & 99 & 3,09 & 51\\
Encargados de Obra & 63 & 1,96 & 50\\
\addlinespace
Electrónicos, electromecánicos e instrumentistas & 59 & 1,84 & 60\\
Baldoseros y ceramistas & 54 & 1,66 & 78\\
Electricistas (técnicos y/o maestros) & 42 & 1,31 & 47\\
Operadores de maquinaria pesada & 34 & 1,04 & 77\\
Bodegueros y cardcheckers & 12 & 0,38 & 72\\
\addlinespace
Mecánicos & 6 & 0,19 & 100\\
Laboratoristas & 4 & 0,11 & 100\\
Sanitarios y gásfiteres & 3 & 0,08 & 100\\
Total & 3220 & 100,00 & NA\\
\bottomrule
\multicolumn{4}{l}{\rule{0pt}{1em}Fuente: Elaboración propia utilizando datos de ENADEL 2023, datos expandidos.}\\
\end{tabular}
