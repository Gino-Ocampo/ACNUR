...
El cargo  “`r vacantes_agro[1,1]`” es el más demandado, con “`r vacantes_agro[1,2]`” vacantes, el segundo cargo más demandado es “`r vacantes_agro[2,1]`” con `r vacantes_agro[2,2]` vacantes y “ `r vacantes_agro[3,1]`” es el tercer cargo más demandado con `r vacantes_agro[3,3]` vacantes.
...
```
@tbl-dificultad_constru muestra que, al considerar el total de menciones, "`r dificultad_tot[1,1]`" (`r dificultad_tot[1,3]` %), fue la dificultad más mencionada, seguida de "`r dificultad_tot[2,1]`" (`r dificultad_tot[2,3]` %) y `r dificultad_tot[3,1]`" (`r dificultad_tot[3,3]` %).
```{r}
